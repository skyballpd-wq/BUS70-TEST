...
const schedule=sheet([['버전','순차','탕','발차지','발차시간','회차지','회차시간','상태'],...Array.from({length:11},(_,i)=>['WD-TEST-V001',i+1,1,'고강동차고지','05:'+String(5*i).padStart(2,'0'),'송내역','06:00','사용'])]);
...
const context={console,JSON,Date,Number,String,Object,Array,PropertiesService:{getScriptProperties:()=>({getProperty:()=>''})},
  ...
  bus70ScheduleVersionForDate_:()=> 'WD-TEST-V001',writeAudit_:()=>{}};
